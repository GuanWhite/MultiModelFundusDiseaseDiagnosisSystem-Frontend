...
def upload_file():
    ...
    if file and allowed_file(file.filename):
        src_path = os.path.join(app.root_path, app.config['UPLOAD_FOLDER'], file.filename)
        file.save(src_path)
        ...
        return jsonify({'status': 1,
                        'image_url': 'http://192.168.1.125:5003/tmp/ct/' + pid,
                        'draw_url': 'http://192.168.1.125:5003/tmp/draw/' + pid,
